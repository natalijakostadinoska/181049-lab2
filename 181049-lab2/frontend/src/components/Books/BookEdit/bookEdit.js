...
const BookEdit = (props) => {
    ...
    const onFormSubmit = (e) => {
       ...
       // const author=props.book.author.id; //always the first one that was saved!
       // const author = formData.author //it works
        const author = formData.author !== 1 ? formData.author : props.book.author.id; //ID author
                        ...
                        <select name="category" className="form-control" onChange={handleChange}>
                            {props.categories.map((term) => {
                                    if (props.book.category !== undefined &&
                                        ...
                                        return <option selected={props.book.category} value={props.book.category}>{
                                            props.book.category.toString()}</option>
                                    else
